...
<head>
  ...
  <!-- Style CSS -->
  <link rel="stylesheet" href="assets/css/vota.css">
  <!-- Favicon  -->
...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="candidato_votar.php">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav ml-auto align-items-center">
        <?php
        if (isset($_GET['nome_candidato'])) {
          $nome_candidato = $_GET['nome_candidato'];
          echo "<li class='nav-item'><a class='nav-link'>$nome_candidato</a></li>";
        } else {
          echo "<li class='nav-item'><a class='nav-link'>Candidato Não Encontrado</a></li>";
        }
        ?>
